...
courses = st.selectbox("Select Your Course", ['AI Enterprise', 'Capstone 2', 'Advanced ML'])

if st.button('Register'):
    if not email or not first_name or not last_name or not year_of_study:
        ...
        if captured:
            ...
            student_data = {
                ...
                "courses": [courses]  # Single course selected from dropdown
            }
